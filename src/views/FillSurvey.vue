        ...
        fetchFirstData() {
            axios.post(`${useNgrokStore().ngrokPath}/quiz/search`, {   
                ...
                .then(response => {
                    ...
                    this.quizResList = this.quizResList.filter(quizRes => quizRes.published);
                ...
                <div class="content">
                        <table>
                            ...
                            <tbody>
                                ...
                                :class="{ 'hovered': currentDeleteId == item.id, 'selected': selectedRowIndex.includes(item.id)}" @click="selectDeleteRow(item.id)">
                                    <!-- <td class="deleteId">
                                        <i class='bx bx-check' v-show="selectedRowIndex.includes(item.id)" ></i>
                                    </td> -->
              
                                    <!-- <td class="id">{{ item.id}}</td> -->
                                    <td class="formName">{{ item.id}}</td> 
